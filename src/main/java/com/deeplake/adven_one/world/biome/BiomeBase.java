...
public class BiomeBase extends Biome {
    ...
    public BiomeBase(BiomePropertiesModified properties, BiomeDictionary.Type... type) {
        super(properties);
        accessibleName = properties.accessibleName;
        InitBiome.initBiome(this, type);
    }
    public BiomeBase(String name, BiomeDictionary.Type... type) {
        this(new BiomePropertiesModified(name), type);
    }
