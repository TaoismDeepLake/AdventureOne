...
public class ComponentBottomDungeonRoomSide extends ComponentDungeonRoomBase{

    public ComponentBottomDungeonRoomSide() {
        super();
    }

    public ComponentBottomDungeonRoomSide(int type, EnumFacing mainDirection, Vec3i vec3i, StructureBottomDungeon.Start start) {
