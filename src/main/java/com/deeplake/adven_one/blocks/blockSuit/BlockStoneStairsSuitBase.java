...
public class BlockStoneStairsSuitBase extends BlockStairs implements IHasModel, IBlockSuit {
    static final String NAME = "stone_stairs";
    EnumSuit suit;
    public BlockStoneStairsSuitBase(EnumSuit suit)
    {
