package com.deeplake.adven_one.entity.creatures.model;
...
public class ModelModSkeleton extends ModelBiped
{
    public ModelModSkeleton()
    {
        this(0.0F, false);
    }

    public ModelModSkeleton(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        if (itemstack.getItem() == Items.BOW && ((EntityModUnit)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntityModUnit abstractskeleton = (EntityModUnit)entityIn;
