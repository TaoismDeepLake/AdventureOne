...
import com.deeplake.adven_one.entity.creatures.ai.EntityAIStrafeRangedAttack;
import com.deeplake.adven_one.entity.projectiles.EntityArrowFixed;
import com.deeplake.adven_one.entity.projectiles.EntityEnemyBullet;
import com.deeplake.adven_one.entity.projectiles.ProjectileArgs;
import com.deeplake.adven_one.item.weapon.ItemPistolBase;
...
//    }
    ...
    public void attackEntityWithBullet(EntityLivingBase target, float distanceFactor) {
        ...
        EntityEnemyBullet entityIdlProjectile = new EntityEnemyBullet(this.world, new ProjectileArgs((float) EntityUtil.getAttack(this)), this,
